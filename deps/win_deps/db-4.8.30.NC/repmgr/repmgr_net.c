 ...
 * We copy the host name, but take ownership of the DB_ADDRINFO buffer.
 *
 * All inputs are assumed to have been already validated.
 *
 * PUBLIC: int __repmgr_pack_netaddr __P((ENV *, const char *,
 * PUBLIC:     u_int, DB_ADDRINFO *, repmgr_netaddr_t *));
 */
int
 ...
 * PUBLIC:     const char *, u_int, int, DB_ADDRINFO **));
 */
int
