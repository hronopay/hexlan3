...
int nAnonymizeHexlanAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Hexlan
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Hexlan
    // Mac: ~/Library/Application Support/Hexlan
    // Unix: ~/.Hexlan
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Hexlan";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Hexlan.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "hexland.pid"));
